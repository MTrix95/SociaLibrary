package it.socialibrary.administratorservice.web;
...
class GlobalExceptionAdvice {
    ...
    public ResponseEntity<String> handleAdminException(AdministratorException ex) {
        log.error("Errore amministrativo: ", ex);
